...
export const template = {
	website_url: 'https://datalakes9.github.io/sreelekha.guggilam.github.io/', // Astro needs to know your site’s deployed URL to generate a sitemap. It must start with http:// or https://
	menu_left: false,
	transitions: false,
